...
<details>
<summary><b>🌍 Walking on Earth, London</b> - Data & ML Intern (Dec 2024 - Present)</summary>

- 📊 Designed **Tableau analytics dashboards** for North Star metrics tracking with real-time KPI monitoring
- 🔄 Led complex **data migration** for Mixpanel integration, restructuring 40+ user event properties
- 🧠 Engineered **LLM-powered mental health report generation** system with automated pipelines
</details>

<details>
<summary><b>🤖 Copilot Innovations, Chicago</b> - GenAI Engineer Intern (Aug 2024 - Dec 2024)</summary>

- 🎙️ Developed **AI-powered LinkedIn automation** Chrome extension with ElevenLabs voice technology
- 💬 Built **conversational AI chatbots** using Voiceflow & OpenAI for enterprise clients
- 🕷️ Created web scraping pipeline processing **6,000+ images** across 30+ global brands
</details>

<details>
<summary><b>📄 TraqCheck, New Delhi</b> - Engineering Intern (May 2024 - Aug 2024)</summary>

- 🏗️ Engineered **Django-based document management platform** with OCR-powered processing
- 🎯 Fine-tuned **DistilBERT** achieving **99% accuracy** in multi-class document classification
</details>
